...
public class Matrices extends javax.swing.JFrame {
    ...
    Arbres arbre;
    Frame frame;
    public Matrices(int i,Arbres arbres,int matriz,Frame frame ) {
        this.i=i;
        this.arbre=arbres;
        this.frame = frame;
        ...
        for (int j = 0; j < i; j++) {
            for (int k = 0; k < i; k++) {
                jTextArea1.append(""+arbre.getAdjacence(j, k)+"\t");
        ...
        if(matriz==2){
         for (int j = 0; j < i; j++) {
            for (int k = 0; k < i; k++) {
                jTextArea1.append(""+arbre.getCoefficient(j, k)+"\t");
            }
            jTextArea1.append("\n");
         }
        }
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder("Matrice"));
